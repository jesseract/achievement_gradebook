...
#   Mayor.create(name: 'Emanuel', city: cities.first)
   ...
   Achievement.create(achievement_description:"Write a paper", points:500)
   Achievement.create(achievement_description:"Present paper to class", points:500)
   Achievement.create(achievement_description:"Write a method", points:500)
   Achievement.create(achievement_description:"Write a class", points:500)
